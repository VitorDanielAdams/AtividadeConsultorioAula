        ...
        try {
            ...
            while (resultSet.next()){
                ...
                switch (resultSet.getString("status_agendamento")){
                    case "Pendente":
                        historico.setStatusAgendamento(StatusAgendamento.pendente);
                        break;
                    case "Aprovado":
                        historico.setStatusAgendamento(StatusAgendamento.aprovado);
                        break;
                    case "Cancelado":
                        historico.setStatusAgendamento(StatusAgendamento.cancelado);
                        break;
                    case "Compareceu":
                        historico.setStatusAgendamento(StatusAgendamento.compareceu);
                        break;
                    case "Não Compareceu":
                        historico.setStatusAgendamento(StatusAgendamento.ncompareceu);
                        break;
                    case "Rejeitado":
                        historico.setStatusAgendamento(StatusAgendamento.rejeitado);
                        break;
                }
